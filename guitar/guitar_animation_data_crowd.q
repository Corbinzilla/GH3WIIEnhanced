...
crowd_animations_rick = {
	...
	special = {
		good = {
			Fast = [
				gh3_crowd_rick_special_fast1
			]
			Med = [
				gh3_crowd_rick_special_med1
			]
			Slow = [
				gh3_crowd_rick_special_slow1
			]
		}
		Normal = {
			Fast = [
	...
	Idle = {
		good = {
			Fast = [
				...
				GH3_crowd_tabledancer_fast_idle2
			]
			Med = [
