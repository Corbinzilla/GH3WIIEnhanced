...
Bonus_Guitars = [
	...
	{
		id = Instrument_Budcat
		price = 2000
	}
	{
		id = Instrument_Controller_01
		price = 2000
	}
	{
		id = Instrument_Controller_02
		price = 2000
	}
	{
		id = Instrument_RayGun
		price = 2000
	}
]
...
Secret_Characters = [
	...
	{
		id = Guitarist_Fowlvis_Outfit1_Style1
		price = 1
		info_name = fowlvis
	}
	{
		id = Guitarist_Robot_Outfit1_Style1
		price = 1
		info_name = Robot
	}
]
...
Bonus_Styles = [
	...
	{
		id = Guitarist_Fowlvis_Outfit1_Style2
		price = 0 
		profile_name = 'Fowlvis'
		info_name = fowlvis
	}
	{
		id = Guitarist_Fowlvis_Outfit1_Style3
		price = 0 
		profile_name = 'Fowlvis'
		info_name = fowlvis
	}
	{
		id = Guitarist_Fowlvis_Outfit1_Style4
		price = 0 
		profile_name = 'Fowlvis'
		info_name = fowlvis
	}
	{
		id = Guitarist_Robot_Outfit1_Style2
		price = 0 
		profile_name = 'Robot'
		info_name = Robot
	}
	{
		id = Guitarist_Robot_Outfit1_Style3
		price = 0 
		profile_name = 'Robot'
		info_name = Robot
	}
	{
		id = Guitarist_Robot_Outfit1_Style4
		price = 0 
		profile_name = 'Robot'
		info_name = Robot
	}
...
Bonus_Characters_Info = [
	...
	{
		item = fowlvis
		text = $string_ps2_fowlvis_blurb
	}
	{
		item = Robot
		text = $string_ps2_robot_blurb
	}
]
