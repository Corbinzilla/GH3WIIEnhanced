...
hud_screen_elements = [
	{
		...
		text = 'Your Star Power Is Ready Sir'
		pos = (340.0, 260.0)
		alpha = 0
		just = [
			center
	...
	{
		id = steal2_text
		text = 'Man, There Is Nothing to steal...'
		pos = (640.0, 300.0)
		scale = 0.7
		just = [
			center
