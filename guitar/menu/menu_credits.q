...
script scrolling_list_add_item \{i = 0}
	...
	if StructureContains Structure = ($credits [<i>]) endoflist
...
script scrolling_list_queue_next_item 
	...
	if (<pos_y> < <screen_height>)
		<i> = (<i> + 1)
		if NOT StructureContains Structure = ($credits [<i>]) endoflist
			if StructureContains Structure = ($credits [<i>]) rate_change
				MathFloor (<rate> * (($credits [<i>]).rate_change))
				<rate> = <floor>
			elseif StructureContains Structure = ($credits [<i>]) texture_array_l
				spawnscriptnow fadein_team_photos params = {team_photos_container = team_photos_container rot_direction = -1 texture_array = ($credits [<i>].texture_array_l) pos = (340.0, 200.0) frame = 1}
				Wait \{0.25
					seconds}
				spawnscriptnow fadein_team_photos params = {team_photos_container = team_photos_container rot_direction = 1 texture_array = ($credits [<i>].texture_array_r) pos = (960.0, 200.0) frame = 2}
			elseif StructureContains Structure = ($credits [<i>]) dims
				<old_dims> = <dims>
				<dims> = (($credits [<i>]).dims)
			elseif StructureContains Structure = ($credits [<i>]) dims_reset
				<dims> = <old_dims>
			else
				scrolling_list_add_item <...>
				return
...
vv_photo_textures_l = [
	endcredits_karthik
	endcredits_skolnick
	endcredits_chrzanowski
	endcredits_osman
	endcredits_dunham
	endcredits_lomerson
	endcredits_sweeney_shutt_phillips
	endcredits_dobert
]
vv_photo_textures_r = [
	endcredits_guha
	endcredits_calvin_hennessy
	endcredits_bukowski_tunon_gawrys
	endcredits_day_khalil
	endcredits_joyner_willey
	endcredits_schroeder
	endcredits_mitchell
	endcredits_qa
]
budcat_photo_textures_l = [
	endcredits_photo_70
	endcredits_photo_63
	endcredits_photo_66
	endcredits_photo_78
...
script fadein_team_photos \{pos = (350.0, 150.0)}
	...
	doScreenElementMorph id = <team_photo_checksum> time = <photo_fade> alpha = 0
	Wait <photo_fade> seconds
	if ScreenElementExists id = <team_photo_checksum>
		DestroyScreenElement id = <team_photo_checksum>
	endif
...
credits = [
	...
	{
		texture_array_l = vv_photo_textures_l
		texture_array_r = vv_photo_textures_r
	}
	{
		title
		item = 'CEO / Chief Creative Officer'
	}
	{
		item = 'Karthik Bala'
	}
	...
	{
		item = 'Michael Bukowski'
	}
	{
		item = 'John A. Day'
	}
	{
		item = 'Alejandro Garcia-Tunon'
	}
	{
		item = 'Thomas Gawrys'
	}
	{
		item = 'Padraic Hennessy'
	}
	{
		item = 'Issam Khalil'
	}
	...
	{
		title
		item = 'VV Quality Assurance Supervisor'
	}
	{
		item = 'Justin Mitchell'
	}
	{
		emptyspace
	}
	...
	{
		title
		item = 'VV Quality Assurance Team Lead'
	}
	{
		item = 'David Dobert'
	}
	...
	{
		item = 'Marc D\'Esposito'
	}
	{
		item = 'Steve Fontanelli'
	}
	{
		item = 'Josh Huff'
	}
	...
	{
		item = 'Christina Chera'
	}
	{
		item = 'Lauren Costello'
	}
	{
		item = 'Nehme Frangie'
	}
	{
		item = 'Dawn Harrington'
	}
	{
		item = 'Kathy Hoppes'
	}
	...
	{
		item = 'Takayoshi \'\'Ty \'\' Katori'
	}
	{
		item = 'Chris McEvoy'
	}
	{
		item = 'D. Chadd Portwine'
	}
	{
		item = 'Tim Schlie'
	}
	...
	{
		title
		item = 'Community Website Development'
	}
	{
		item = 'Agora Games'
	}
	...
	{
		item = 'This software uses the RSA Data Security, Inc. MD5 Message-Digest Algorithm'
	}
	{
		emptyspace
	}
	...
	{
		texture_array_l = budcat_photo_textures_l
		texture_array_r = budcat_photo_textures_r
	}
	{
		photo_wait = 1
	}
	...
	{
		texture_array_l = neversoft_photo_textures_l
		texture_array_r = neversoft_photo_textures_r
	}
	{
		heading
	...
	{
		item = 'Eddie Fernando Araujo, Lucas Goodman,'
	}
	{
		item = 'Justin Gogue, Rich Bantegui,'
	}
	{
		item = 'Kyle Bean, Santiago Salvador,'
	}
	{
		item = 'Steve Mcilroy, Joe Pardo,'
	}
	{
		item = 'Jeff Koyama, Anthony Rocha'
	}
	{
		item = 'Brian Papa'
	}
	...
	{
		title
		item = 'Mod Made By Corbinzilla'
	}
	{
		small
		item = 'I Cant Thank You Enough For Taking Time Out Of YOUR Day To Play My Mod'
	}
	{
		endoflist
	}
