...
script create_controller_settings_menu \{popup = 0}
	...
	if (<popup>)
		...
		text_params = {parent = cs_vmenu type = TextElement font = ($cs_menu_font) rgba = ($menu_unfocus_color) z_priority = <z> scale = (1.2, 1.0667)}
		...
		new_menu scrollid = cs_scroll vmenuid = cs_vmenu menu_pos = <menu_pos> text_left spacing = 8
		...
		font = text_a6
		z = 5
		text_params = {parent = cs_vmenu type = TextElement font = <font> scale = 0.8 rgba = ($menu_unfocus_color) z_priority = <z> rot_angle = 1.5}
