...
highway_fade1 = 0
gem_start_scale1_normal = 0.5
gem_end_scale1_normal = 0.8
gem_start_scale1 = 0.5
gem_end_scale1 = 0.8
gem_star_scale1 = 1.3
gem_y_just1 = 0.83
star_y_just1 = 0.5
...
sidebar_x_scale1 = 0.6
sidebar_y_scale1 = 2.0
...
highway_fade2 = 0
large_gem_scale = 0.7
gem_start_scale2_normal = 0.54
gem_end_scale2_normal = 0.8
gem_start_scale2 = 0.54
gem_end_scale2 = 0.8
gem_star_scale2 = 1.3
gem_y_just2 = 0.83
star_y_just2 = 0.5
...
sidebar_x_scale2 = 0.6
sidebar_y_scale2 = 1.5
starpower_fx_scale2 = 0.75
nowbar_scale_x2 = 1.3199999
nowbar_scale_y2 = 1.6
string_scale_x2 = 1.3
string_scale_y2 = 1.0
x_offset_p2 = 235
...
highway_starpower = [64 160 160 255]
highway_pulse = [
	0
	0
	0
...
ngc_practice_mode_pitchshift_offset_song = 0
xenon_practice_mode_pitchshift_offset_slow = 0
ps3_practice_mode_pitchshift_offset_slow = -32
ps2_practice_mode_pitchshift_offset_slow = 0
ngc_practice_mode_pitchshift_offset_slow = 0
xenon_practice_mode_pitchshift_offset_slower = 0
ps3_practice_mode_pitchshift_offset_slower = -32
ps2_practice_mode_pitchshift_offset_slower = 0
ngc_practice_mode_pitchshift_offset_slower = 0
xenon_practice_mode_pitchshift_offset_slowest = 0
ps3_practice_mode_pitchshift_offset_slowest = -32
ps2_practice_mode_pitchshift_offset_slowest = 0
ngc_practice_mode_pitchshift_offset_slowest = 64
