...
GH3_Career_Songs = {
	...
	tier2 = {
		title = '2. Your first real gig, man. it probably sucks'
		songs = [
			mississippiqueen
			schoolsout
			sunshineofyourlove
	...
	tier4 = {
		title = '4. European Invasion, how cool'
		songs = [
			paranoid
			anarchyintheuk
			koolthing
